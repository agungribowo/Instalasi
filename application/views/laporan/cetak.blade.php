                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $data_laporan['tanggal_instalasi']}}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Nama Customer : </th>
                                    <td class="text-center">{{ $data_laporan['nama_customer']}}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">No Hp : </th>
                                    <td class="text-center">{{ $data_laporan['no_hp'] }}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Alamat : </th>
                                    <td class="text-center">{{ $data_laporan['alamat']}}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Nama Produk : </th>
                                    <td class="text-center">{{ $data_laporan['nama_produk'] }}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Jenis Produk : </th>
                                    <td class="text-center">{{ $data_laporan['jenis_produk'] }}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Teknisi Yang Bertugas : </th>
                                    <td class="text-center">{{ $data_laporan['nama_installer'] }}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Hasil Perbaikan : </th>
                                    <td class="text-center">{{ $data_laporan['hasil_perbaikan'] }}</td>
                                </tr>
                                <tr>
                                    <th class="text-center">Hasil Kerja : </th>
                                    <td class="text-center">{{ $data_laporan['hasil_kerja'] }}</td>
                                </tr>
                                <tr>
