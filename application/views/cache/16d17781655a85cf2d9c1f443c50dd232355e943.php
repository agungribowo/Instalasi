                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $no = 1 ?>
                                        <?php $__currentLoopData = $installer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ins): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-center"><?php echo e($no); ?> .</td>
                                                <td class="text-center"><?php echo e($ins['kode_installer']); ?></td>
                                                <td class="text-center"><?php echo e($ins['nama_installer']); ?></td>
                                                <td class="text-center"><?php echo e($ins['no_hp']); ?></td>
                                                <td class="text-center"><?php echo e($ins['alamat']); ?></td>
                                                <td class="text-center"><?php echo e($ins['username']); ?></td>
                                                <td class="text-center">
                                                    <img src="<?=base_url()?>_assets/img/foto_profile/installer/<?php echo e($ins['foto']); ?>" alt="foto" class="img-circle img-responsive" style="height:65px; width:65px;">
                                                </td>
                                                <td class="text-center"> 
                                                    <a href="javascrpt:void(0)" type="button" class="btn btn-warning btn-sm edit_installer" data-toggle="modal" data-kode_installer="<?php echo e($ins['kode_installer']); ?>" data-nama_installer="<?php echo e($ins['nama_installer']); ?>" data-no_hp="<?php echo e($ins['no_hp']); ?>" data-alamat="<?php echo e($ins['alamat']); ?>" data-username="<?php echo e($ins['username']); ?>"> Ubah</a>
                                                    <a href="<?=base_url()?>page/installer_hapus/<?php echo e($ins['id_installer']); ?>" type="button" class="btn btn-danger btn-sm"> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php $no++ ?>
                ...
                <?= form_open_multipart('page/installer_tambah') ?>
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="kode_installer" id="kode_installer" value="<?php echo e($kode_installer); ?>" readonly style="background-color:#0000002e">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/instalasi/application/views/installer/list.blade.php ENDPATH**/ ?>