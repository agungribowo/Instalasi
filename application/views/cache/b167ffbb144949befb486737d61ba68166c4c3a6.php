                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php $__currentLoopData = $cs_store; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td class="text-center"><?php echo e($no); ?> .</td>
                                                <td class="text-center"><?php echo e($cs['kode_cs_store']); ?></td>
                                                <td class="text-center"><?php echo e($cs['nama_cs_store']); ?></td>
                                                <td class="text-center"><?php echo e($cs['no_hp']); ?></td>
                                                <td class="text-center"><?php echo e($cs['alamat']); ?></td>
                                                <td class="text-center"><?php echo e($cs['username']); ?></td>
                                                <td class="text-center">
                                                    <img src="<?=base_url()?>_assets/img/foto_profile/<?php echo e($cs['foto']); ?>" alt="foto" class="img-circle img-responsive" style="height:8%; width:65px;">
                                                </td>
                                                <td class="text-center"> 
                                                    <a href="javascrpt:void(0)" type="button" class="btn btn-warning btn-sm edit_cs" data-toggle="modal" data-kode_cs="<?php echo e($cs['kode_cs_store']); ?>" data-nama_cs="<?php echo e($cs['nama_cs_store']); ?>" data-no_hp="<?php echo e($cs['no_hp']); ?>" data-alamat="<?php echo e($cs['alamat']); ?>" data-username="<?php echo e($cs['username']); ?>"> Ubah</a>
                                                    <a href="<?=base_url()?>page/cs_store_hapus/<?php echo e($cs['id_cs_store']); ?>" type="button" class="btn btn-danger btn-sm"> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php $no++;?>
                ...
                <?= form_open_multipart('page/cs_store_tambah') ?>
                    <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" name="kode_cs_store" id="kode_cs_store" value="<?php echo e($kode_cs_store); ?>" readonly style="background-color:#0000002e">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/Instalasi/application/views/cs_store/list.blade.php ENDPATH**/ ?>